...
| global.observability.metrics.serviceMonitor.interval | string | `"60s"` |  |
| global.observability.metrics.serviceMonitor.labels | object | `{}` |  |
| global.observability.traces.otlp.endpoint | string | `""` |  |
| global.observability.traces.otlp.protocol | string | `"grpc"` |  |
...
| components.kagent.controllerRoute.parentRef.name | string | `""` |  |
| components.kagent.controllerRoute.parentRef.namespace | string | `""` |  |
...
| components.kagent.uiRoute.parentRef.name | string | `""` |  |
| components.kagent.uiRoute.parentRef.namespace | string | `""` |  |
...
| backstage.backstage.extraEnvVars[2].value | string | `"/etc/agent-platform/idp-ca/{{ .Values.global.identity.ca.key }}"` |  |
