...
| oci://gsoci.azurecr.io/charts/giantswarm | agent-manager | 0.4.0 |
| oci://gsoci.azurecr.io/charts/giantswarm | agent-platform-mcps | 0.9.1 |
| oci://gsoci.azurecr.io/charts/giantswarm | agent-sandbox | 0.2.31 |
| oci://gsoci.azurecr.io/charts/giantswarm | agentgateway | 2.0.7 |
| oci://gsoci.azurecr.io/charts/giantswarm | backstage | 0.239.0 |
...
| oci://gsoci.azurecr.io/charts/giantswarm | muster | 5.12.0 |
...
| components.model-manager.networkPolicy.ingress.additionalPeers[0]."app.kubernetes.io/instance" | string | `"backstage"` |  |
| components.model-manager.networkPolicy.ingress.additionalPeers[0].component | string | `"backstage"` |  |
...
| components.agent-manager.networkPolicy.ingress.additionalPeers[0]."app.kubernetes.io/instance" | string | `"backstage"` |  |
| components.agent-manager.networkPolicy.ingress.additionalPeers[0].component | string | `"backstage"` |  |
