...
func TestTransformShape(t *testing.T) {
	...
	require.Equal(t, []string{
		"global", "components", "ingress", "muster", "kagent", "agent-platform-mcps",
	}, mappingKeys(rootMapping(document)), "keep, components, wiring, then component blocks in dependency order")
...
func TestTransformPreservesCommentsAndDropsSchemaAnnotations(t *testing.T) {
